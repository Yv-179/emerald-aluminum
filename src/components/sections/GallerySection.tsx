...
const PROJECTS = [
  {
    src: "/gallery/01.jpg",
    alt: "חלון אלומיניום הזזה",
    label: "חלון הזזה 4 כנפיים",
  },
  {
    src: "/gallery/02.jpg",
    alt: "התקנת חלון גדול בסלון",
    label: "חלון פנורמי בסלון",
  },
  {
    src: "/gallery/03.jpg",
    alt: "סגירת מרפסת",
  ...
  {
    src: "/gallery/04.jpg",
    alt: "חדר עבודה אטום לרעשים",
    label: "חדר עבודה אטום לרעשים",
  },
  {
    src: "/gallery/05.jpg",
    alt: "חלונות אמבטיה עם זכוכית חלבית",
    label: "חלונות אמבטיה",
  },
  {
    src: "/gallery/06.jpg",
    alt: "צירמרים בצפון",
    label: "חלונות חזית של צימר",
  },
] as const;
